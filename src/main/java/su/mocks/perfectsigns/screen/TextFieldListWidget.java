...
public class TextFieldListWidget extends AlwaysSelectedEntryListWidget<TextFieldListWidget.Entry> {
  ...
  public void appendClickableNarrations(NarrationMessageBuilder builder) {
    builder.put(NarrationPart.TITLE, Text.translatable("narration.perfectsigns.text_field_list"));
    builder.put(NarrationPart.USAGE, Text.translatable("narration.perfectsigns.text_field_list.usage"));
   ...
   */
  @Environment(EnvType.CLIENT)
  public class Entry extends AlwaysSelectedEntryListWidget.Entry<TextFieldListWidget.Entry> {
